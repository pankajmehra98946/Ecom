    ...
    try {
		...
		// create the product
         $id=$data->id;
            ...
            $sql = "UPDATE `coupon` SET `id`=$id,`coupon_name`='$coupon_name',
                    `coupon_code`='$coupon_code',`coupon_value`=$coupon_value,
                    `coupon_start`='$coupon_start',`coupon_end`='$coupon_end',
                    `coupon_limit`=$coupon_limit, `coupon_status`=$coupon_status 
                    WHERE id=$id";
